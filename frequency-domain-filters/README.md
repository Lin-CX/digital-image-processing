...
<div  align="center"><kbd>    
    <img src="./images/image2.png" align=center width="70%" />
</kbd></div><br>
...
<div  align="center"><kbd>    
    <img src="./images/image3.png" align=center width="70%" />
</kbd></div><br>
...
<div  align="center"><kbd>    
    <img src="./images/image4.png" align=center width="70%" />
</kbd></div><br>

<div  align="center"><kbd>    
    <img src="./images/image5.png" align=center width="70%" />
</kbd></div><br>
...
* D0이 70이고 n은 2인 Butterworth LPF를 사용해서 Highpass Filters를 구합니다. 아래 그림은 k가 10으로 조정되었을 때 나오는 그림입니다. 
  ...
  <div  align="center"><kbd>    
      <img src="./images/image7.png" align=center width="70%" />
  </kbd></div><br>

* k가 1로 조정되면 나온 결과는 다음과 같습니다. 

<div  align="center"><kbd>    
    <img src="./images/image8.png" align=center width="70%" />
</kbd></div><br>

* k가 클 수록 F(u, v)에 더하는 숫자가 커지고 효과가 분명하게 나오는 반면, k가 작을 수록 input의 차이가 작습니다. 

<div  align="center"><kbd>    
    <img src="./images/image9.png" align=center width="70%" />
</kbd></div><br>
...
<div  align="center"><kbd>    
    <img src="./images/image10.png" align=center width="70%" />
</kbd></div><br>
...
<div  align="center"><kbd>    
    <img src="./images/image12.png" align=center width="70%" />
</kbd></div><br>

* 그리고 아래는 Input 그림과 result 그림의 Fourier spectrum(스펙트럼?)입니다.

<div  align="center"><kbd>    
    <img src="./images/image13.png" align=center width="70%" />
</kbd></div><br>